...
public class NetworkUtils {
	...
	public static String[] getNetworkState(Context pContext) {
		...
		if (pContext.getPackageManager().checkPermission("android.permission.ACCESS_NETWORK_STATE", pContext.getPackageName()) == PackageManager.PERMISSION_GRANTED) {
			ConnectivityManager localConnectivityManager = (ConnectivityManager) pContext.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	public static String getWifiAddress(Context pContext) {
		...
		if (pContext != null) {
			WifiInfo localWifiInfo = ((WifiManager) pContext.getApplicationContext().getSystemService(Context.WIFI_SERVICE)).getConnectionInfo();
	...
	public static String getWifiIpAddress(Context pContext) {
		...
		if (pContext != null) {
			localWifiInfo = ((WifiManager) pContext.getApplicationContext().getSystemService(Context.WIFI_SERVICE)).getConnectionInfo();
			if (localWifiInfo != null) {
