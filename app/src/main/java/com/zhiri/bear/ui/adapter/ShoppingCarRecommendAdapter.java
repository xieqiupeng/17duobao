 ...
 */
public class ShoppingCarRecommendAdapter extends RecyclerView.Adapter<ShoppingCarRecommendAdapter.ViewHolder> {
    public ArrayList<RobGoodsList> datas = null;
    private int itemWidth;

    public ShoppingCarRecommendAdapter(ArrayList<RobGoodsList> datas) {
        this.datas = datas;
    }
